...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    internal class HPMixedRealityControllerProfile : OpenXRInteractionFeature
    {
        ...
        public class HPMixedRealityController : XRControllerWithRumble
        {
            ...
            /// <summary>
            /// A <see cref="HapticControl"/> that represents the <see cref="HPMixedRealityControllerProfile.haptic"/> binding.
            /// </summary>
...
#if UNITY_OPENXR_1_9_OR_NEWER
        /// <summary>
        /// Return device layout string that's used for registering device for Input System.
        /// </summary>
