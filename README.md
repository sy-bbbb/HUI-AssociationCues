...
* 본 연구는 2025년도 정부(과학기술정보통신부)의 재원으로 정보통신기획평가원의 지원을 받아 수행된 연구임 (RS-2019-II191270, (SW 스타랩) 스마트 안경을 위한 WISE AR UI/UX 플랫폼 개발)

# License
WiseUI Applications are released under a MIT license. For a closed-source version of WiseUI's modules for commercial purposes, please contact the authors : uvrlab@kaist.ac.kr, bbbbanga@kaist.ac.kr
